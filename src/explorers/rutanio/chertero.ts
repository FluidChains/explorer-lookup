...
const serviceURL: ExplorerURLs = {
  main: `https://core.chertero.com/ruta/api/query/transaction/${TRANSACTION_ID_PLACEHOLDER}`,
  test: `https://core.chertero.com/ruta/api/query/transaction/${TRANSACTION_ID_PLACEHOLDER}`
};

export const explorerApi: ExplorerAPI = {
  serviceURL,
  serviceName: TRANSACTION_APIS.cherteroruta,
  parsingFunction,
  priority: -1
};
